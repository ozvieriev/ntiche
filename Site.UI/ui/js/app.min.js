...
angular.module('app.controllers').controller('examPostTestController', ['$scope', '$sce', '$form', '$api', '$dict', '$filter', function ($scope, $sce, $form, $api, $dict, $filter) {
  ...
  $scope.submit = function (form) {
    $form.submit($scope, form, function () {
      ...
      for (var index = 0; index < questions.length; index++) {
        ...
        answers["answer".concat(index)] = question.answers.indexOf(selectedAnswer);
      }
