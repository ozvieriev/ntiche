...
angular.module('app.controllers').controller('accountIndexController', ['$scope', '$state', '$api', function ($scope, $state, $api) {
...
angular.module('app.controllers').controller('examPreTestController', ['$scope', '$sce', '$form', '$api', function ($scope, $sce, $form, $api) {
  var _exam = 'pre-test';
  $scope.model = {};
  $scope.status = null;
  $scope.description = null;
